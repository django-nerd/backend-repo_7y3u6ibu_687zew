...
def generate_melody_preview(req: MelodyPreviewRequest):
    ...
    guideAudioUrl = None
    if MOCK_MODE:
        # Provide a tiny data URL as placeholder sine beep so audio element works
        guideAudioUrl = "data:audio/wav;base64,UklGRiQAAABXQVZFZm10IBAAAAABAAEAESsAACJWAAACABYAAAAAAACAgICAgP//"  # very short dummy
    else:
        # TODO: integrate real melody generation here, return proper URLs
        pass
